...
function showToast(message, type = "success", forLeadForm = false) {
  ...
  toast.classList.add("toast", "show", bgColor, "text-white", "fade");
...
// ── config.js ── This entire section may need to be delete or at least modified
...
function applyThemeSettings(settings = {}) {
  document.documentElement.classList.remove(
    "light-theme","dark-theme","green-theme","blue-theme","purple-theme"
  );
  if (settings.theme) {
